...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="Styles/mau.css" />
  </head>
  <body>
<header>
       <?php
...
<div id="main-content">
    ...
    <?php
            ...
            require_once 'processing_user.php';

    ?>
            <?php 
            if(isset($_SESSION['message'])){
            echo '<div class="alert alert-'. $_SESSION['msg_type'] .'" id="check_set_message">';
        ...
        <div class="container">
    <?php
            $result = $connect_database_users->query("SELECT id, username, first_name, last_name, email, is_admin FROM users"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="mainAdminUser.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="mainAdminUser.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
    ...
    ?>
    <div class="row justify-content-center">
    <form action="processing_user.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
        ...
        <div class="form-group">
            ...
            <input type="checkbox" name="check_admin" class="form-check"
            
            <?php if($user_admin_privilege === 'Yes'){
                echo "checked";
            }
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        <script src="scripts/remove_msg.js"></script>
