...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_accommodation_comments.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_comments->query("SELECT id, user_name, body, created_date FROM housing_comments"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="accommodation_comments.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="accommodation_comments.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_accommodation_comments.php" method="POST">
