...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_images_data.php';
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, source, comments FROM images"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="images_admin.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="images_admin.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_images_data.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
        ...
        <div class="form-group">
            ...
            <textarea  name="source" rows="10" cols="50" class="form-control" 
             placeholder="Enter the source"> <?php echo $source; ?></textarea>
        </div>
        <div class="form-group">
