...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="Styles/Food&Bar_admin.css">
  </head>
  <body>
      <?php

            include 'processing_general_admin.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, information, comments FROM other_places_data"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="Food&Bar_admin.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="Food&Bar_admin.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_general_admin.php" method="POST">
