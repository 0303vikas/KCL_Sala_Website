...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_official_places_data.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, information, comments FROM official_places_data"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="official_places_admin.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="official_places_admin.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_official_places_data.php" method="POST">
