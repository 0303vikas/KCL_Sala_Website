...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_accommodation_data.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, information, comments FROM accommodation_data"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="accommodation_admin.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="accommodation_admin.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_accommodation_data.php" method="POST">
...
<link rel="stylesheet" href="Styles/accommodation_admin.css">
    <!-- Optional JavaScript -->
