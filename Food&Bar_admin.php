...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_Food&Bar_data.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, information, comments FROM food_and_bar_data"); 
...
<div class="row justify-content-center">
    <form action="processing_Food&Bar_data.php" method="POST">
