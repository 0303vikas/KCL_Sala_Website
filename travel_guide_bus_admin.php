...
<html lang="en">
  ...
  <body>
      <?php
            ...
            include 'processing_travel_guide_data_bus.php';
?>
<header>
...
<div id="main-content">
  ...
  <div class="container">
    <?php
            $result = $db_connect_info->query("SELECT id, information, comments FROM travel_guide_data_part2_data"); 
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                    ...
                                    <td>
                                        <a href="travel_guide_bus_admin.php?edit=<?php echo $row['id']?>" class="btn btn-info">Edit</a>
                                        <a href="travel_guide_bus_admin.php?delete=<?php echo $row['id']?>" class="btn btn-danger">Delete</a>
                                    </td>
                            </tr>
...
<div class="row justify-content-center">
    <form action="processing_travel_guide_data_bus.php" method="POST">
